<div style="color: #004085; background-color: #cce5ff; border-color: #004085; border-radius: 4px; border-right: 0.2rem solid; border-left: 0.2rem solid; padding: 1rem; width: 70%; border-radius: 4px;">
    ...
    <div style="font-size: 1rem;">La  tâche {{ $det['titre_tache']  }} en attente de traitement. <p>Detail : {{ $det['desc_tache'] }}</p> <p style="color: red;" >Date limite de traitement: {{ $det['delais'] }}</p> <p>Bien vouloir consulter les details de la  tâche sur l'outils de pilotage.</p></div>
</div>
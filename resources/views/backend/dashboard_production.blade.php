...
@section('dash_content')
    ...
    <div class="card">
      <div class="card-header border-0">
        <h3 class="card-title"> Statistique Production hier </center></h3>
      ...
      <div class="row">
          <div class="col-md-6">
            <div class="row">
              ...
              <div class="col-md-5">
                  {{ $nombre_de_carte_produits_hier->sum('nbre_carte_imprime') }}
              </div>
           </div>
           <div class="row">
            <div class="col-md-7">
                <p style="margin-left: 10px;">Nombre de lots introduits :</p>
            </div>
            <div class="col-md-5">
                {{ $nombre_de_carte_produits_hier->sum('nbre_lot_introduit') }}
            </div>
          </div>
           <div class="row">
            <div class="col-md-7">
                <p style="margin-left: 10px;">Nombre de demande saisie :</p>
            </div>
            <div class="col-md-5">
                {{ $nombre_de_carte_produits_hier->sum('nbre_demande_saisie') }}
            </div>
         </div>
           ...
           <div class="row">
            ...
            <div class="col-md-5">
                {{ $nombre_de_carte_produits_hier->sum('nbre_carte_endomage') }}
            </div>
         </div>
         <div class="row">
          <div class="col-md-7">
          ...
          <div class="col-md-5">
              {{ $nombre_de_carte_produits_hier->sum('nbre_demande_en_instance') }}
          </div>
       </div>
       <div class="row">
        <div class="col-md-7">
        ...
        <div class="col-md-5">
            {{ $nombre_de_carte_produits_hier->sum('nbre_carte_transmise') }}
        </div>
     </div>
        </div>
         <div class="col-md-6">
          <div class="row">
            ...
            <div class="col-md-5">
                {{ $nombre_de_passport_produits_hier->sum('nbre_passport_ordi_produit') }}
            </div>
         </div>
         <div class="row">
          <div class="col-md-7">
          ...
          <div class="col-md-5">
              {{ $nombre_de_passport_produits_hier->sum('nbre_passport_ordinaire_rejete') }}
          </div>
       </div>
       <div class="row">
          <div class="col-md-7">
          ...
          <div class="col-md-5">
              {{ $nombre_de_passport_produits_hier->sum('nbre_passport_ord_vierge_restant') }}
          </div>
       </div> 
       <div class="row">
        <div class="col-md-7">
        ...
        <div class="col-md-5">
            {{ $nombre_de_passport_produits_hier->sum('nbre_passport_refugie_produit') }}
        </div>
     </div>
         </div>
      </div>

...
<div class="block-title">
    <center><h3><strong>Ajouter un paramètre</strong></h3></center>                    
</div>
                <div class="card-body">
                    <div class="table table-bordered table-striped">
                    <form id="form-validation" method="POST"  action="{{route('parametre.store')}}" class="form-horizontal form-bordered">
                        {{ csrf_field() }}
                    ...
                    <div class="col-md-8 col-md-offset-4">
                        ...
                        <a href="{{ route('parametre.index') }}" class="btn btn-sm btn-warning"><i class="fa fa-repeat"></i> Annuler</a>
                    </div>
                </div>
                </form>
                </div>                

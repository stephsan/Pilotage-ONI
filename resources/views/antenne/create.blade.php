        ...
        <div class="row">
            <div class="card card-success col-md-8 col-md-offset-2">
                <div class="card-header">
                  <h3 class="card-title">Créer une nouvelle antenne</h3>
                </div>
                <div class="card-body">
                    <form id="form-validation" method="POST"  action="{{route('antenne.store')}}" class="form-horizontal form-bordered">
                        {{ csrf_field() }}
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                            <label class="col-md-4 control-label" for="name">Denomination de l'antenne<span class="text-danger">*</span></label>
                            <div class="col-md-6">

...
<table id="example1" class="table table-bordered table-striped">
        <thead>
                <tr>
                    ...
                    <th>Dossiers transmis</th>
                    <th>Dossiers rejétés</th>
        ...
        <tbody>
            @foreach($registres as $registre)
                <tr>
                    ...
                    <td>{{$registre->nbre_dossier_recu}}</td>
                    <td>{{$registre->nbre_dossier_traite}}</td>
                    <td>{{$registre->nbre_dossier_transmis}}</td>
                    <td>{{$registre->nbre_dossier_rejete}}</td>
                    <td>{{$registre->nbre_dossier_en_instance}}</td>
        ...
        <div class="modal-body">
            <form id="form-validation" method="POST"  action="{{ route('registre.modifier') }}" class="form-horizontal form-bordered" enctype="multipart/form-data">
               ...
               <fieldset>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group{{ $errors->has('nbre_dossier_recu') ? ' has-error' : '' }}">
                            <label class=" control-label" for="nbre_dossier_recu">Dossiers recus<span class="text-danger">*</span></label>
                            <input id="nbre_dossier_recu_u" type="number"  class="form-control" name="nbre_dossier_recu" min="0" placeholder="Entrer nombre de photos a verifier" required autofocus>    
                                @if ($errors->has('nbre_dossier_recu'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('nbre_dossier_recu') }}</strong>
                                </span>
                                @endif
                            </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group{{ $errors->has('nbre_dossier_traite') ? ' has-error' : '' }}">
                            <label class=" control-label" for="nbre_dossier_traite">Dossiers traités<span class="text-danger">*</span></label>
                            <input id="nbre_dossier_traite_u" type="number"  class="form-control" name="nbre_dossier_traite" min="0" placeholder="Entrer nombre de photos enrolées manuellement" required autofocus>    
                                @if ($errors->has('nbre_dossier_traite'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('nbre_dossier_traite') }}</strong>
                                </span>
                                @endif
                            </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group{{ $errors->has('nbre_dossier_transmis') ? ' has-error' : '' }}">
                            <label class=" control-label" for="nbre_dossier_transmis">Dossiers transmis<span class="text-danger">*</span></label>
                            <input id="nbre_dossier_transmis_u" type="number"  class="form-control" name="nbre_dossier_transmis" min="0" placeholder="Entrer de photo triées" required autofocus>    
                                @if ($errors->has('nbre_dossier_transmis'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('nbre_dossier_transmis') }}</strong>
                                </span>
                                @endif
                            </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group{{ $errors->has('nbre_dossier_rejete') ? ' has-error' : '' }}">
                            <label class=" control-label" for="nbre_dossier_rejete">Dossiers réjetés<span class="text-danger">*</span></label>
                            <input id="nbre_dossier_rejete_u" type="number"  class="form-control" name="nbre_dossier_rejete" min="0" placeholder="Entrer nombre de photos investigués" required autofocus>    
                                @if ($errors->has('nbre_dossier_rejete'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('nbre_dossier_rejete') }}</strong>
                                </span>
                                @endif
                            </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group{{ $errors->has('nbre_dossier_en_instance') ? ' has-error' : '' }}">
                            <label class=" control-label" for="nbre_dossier_en_instance">Dossiers en instance<span class="text-danger">*</span></label>
                            <input id="nbre_dossier_en_instance_u" type="number"  class="form-control" name="nbre_dossier_en_instance" min="0" placeholder="Nombre de photo en attente de tirage" required autofocus>    
                                @if ($errors->has('nbre_dossier_en_instance'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('nbre_dossier_en_instance') }}</strong>
                                </span>
                                @endif
                            </div>
                    </div>
               ...
               <fieldset>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group{{ $errors->has('nbre_dossier_recu') ? ' has-error' : '' }}">
                            <label class=" control-label" for="nbre_dossier_recu">Dossiers recus<span class="text-danger">*</span></label>
                            <input id="nbre_dossier_recu" type="number"  class="form-control" name="nbre_dossier_recu" min="0" placeholder="Entrer nombre de photos a verifier" required autofocus>    
                                @if ($errors->has('nbre_dossier_recu'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('nbre_dossier_recu') }}</strong>
                                </span>
                    ...
                    <div class="col-md-4">
                        <div class="form-group{{ $errors->has('nbre_dossier_traite') ? ' has-error' : '' }}">
                            <label class=" control-label" for="nbre_dossier_traite">Dossiers traités<span class="text-danger">*</span></label>
                            <input id="nbre_dossier_traite" type="number"  class="form-control" name="nbre_dossier_traite" min="0" placeholder="Entrer nombre de photos enrolées manuellement" required autofocus>    
                                @if ($errors->has('nbre_dossier_traite'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('nbre_dossier_traite') }}</strong>
                                </span>
                    ...
                    <div class="col-md-4">
                        <div class="form-group{{ $errors->has('nbre_dossier_transmis') ? ' has-error' : '' }}">
                            <label class=" control-label" for="nbre_dossier_transmis">Dossiers transmis<span class="text-danger">*</span></label>
                            <input id="nbre_dossier_transmis" type="number"  class="form-control" name="nbre_dossier_transmis" min="0" placeholder="Entrer de photo triées" required autofocus>    
                                @if ($errors->has('nbre_dossier_transmis'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('nbre_dossier_transmis') }}</strong>
                                </span>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group{{ $errors->has('nbre_dossier_rejete') ? ' has-error' : '' }}">
                            <label class=" control-label" for="nbre_dossier_rejete">Dossiers réjetés<span class="text-danger">*</span></label>
                            <input id="nbre_dossier_rejete" type="number"  class="form-control" name="nbre_dossier_rejete" min="0" placeholder="Entrer nombre de photos investigués" required autofocus>    
                                @if ($errors->has('nbre_dossier_rejete'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('nbre_dossier_rejete') }}</strong>
                                </span>
                    ...
                    <div class="col-md-4">
                        <div class="form-group{{ $errors->has('nbre_dossier_en_instance') ? ' has-error' : '' }}">
                            <label class=" control-label" for="nbre_dossier_en_instance">Dossiers en instance<span class="text-danger">*</span></label>
                            <input id="nbre_dossier_en_instance" type="number"  class="form-control" name="nbre_dossier_en_instance" min="0" placeholder="Nombre de photo en attente de tirage" required autofocus>    
                                @if ($errors->has('nbre_dossier_en_instance'))
                                <span class="help-block">
                                    <strong>{{ $errors->first('nbre_dossier_en_instance') }}</strong>
                                </span>
            ...
            var url = "{{ route('registre.getById') }}";
                $.ajax({
                    ...
                    success:function(data){
                        ...
                        $("#nbre_dossier_recu_u").val(data.nbre_dossier_recu);
                        $("#nbre_dossier_traite_u").val(data.nbre_dossier_traite);
                        $("#nbre_dossier_transmis_u").val(data.nbre_dossier_transmis);
                        $("#nbre_dossier_rejete_u").val(data.nbre_dossier_rejete);
                        $("#nbre_dossier_en_instance_u").val(data.nbre_dossier_en_instance); 

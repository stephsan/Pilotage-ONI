                ...
                <div class="row">
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('nbre_lot_introduit') ? ' has-error' : '' }}">
                                <label class=" control-label" for="nbre_lot_introduit">Nbre de carte disponibles<span class="text-danger">*</span></label>
                                <input id="nbre_de_carte_disponible_u" type="number"  class="form-control" name="nbre_de_carte_disponible" min="0" placeholder="Entrer nombre de demande saisie" required autofocus>    
                                    @if ($errors->has('nbre_de_carte_disponible'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('nbre_de_carte_disponible') }}</strong>
                                    </span>
                                    @endif
                                </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('nbre_de_carte_restitue') ? ' has-error' : '' }}">
                                <label class=" control-label" for="nbre_demande_saisie">Nbre de cartes restituées<em></em><span class="text-danger">*</span></label>
                                <input id="nbre_de_carte_restitue_u" type="number"  class="form-control" name="nbre_de_carte_restitue" min="0" placeholder="Entrer nombre de photos enrolées manuellement" required autofocus>    
                                    @if ($errors->has('nbre_de_carte_restitue'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('nbre_de_carte_restitue') }}</strong>
                                    </span>
                                    @endif
                                </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('nbre_de_carte_recus') ? ' has-error' : '' }}">
                                ...
                                <input id="nbre_de_carte_recus_u" type="number"  class="form-control" name="nbre_de_carte_recus" min="0" placeholder="Entrer nombre de photos enrolées manuellement" required autofocus>    
                                    ...
                                    <span class="help-block">
                                        <strong>{{ $errors->first('nbre_de_carte_recus') }}</strong>
                                    </span>
                                    @endif
                                </div>
                        </div>
                ...
                <legend>Statistique du jour</legend>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('nbre_lot_introduit') ? ' has-error' : '' }}">
                                <label class=" control-label" for="nbre_lot_introduit">Nbre de carte disponibles<span class="text-danger">*</span></label>
                                <input id="nbre_de_carte_disponible" type="number"  class="form-control" name="nbre_de_carte_disponible" min="0" placeholder="Entrer nombre de demande saisie" required autofocus>    
                                    @if ($errors->has('nbre_de_carte_disponible'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('nbre_de_carte_disponible') }}</strong>
                                    </span>
                        ...
                        <div class="col-md-6">
                            <div class="form-group{{ $errors->has('nbre_de_carte_restitue') ? ' has-error' : '' }}">
                                <label class=" control-label" for="nbre_demande_saisie">Nbre de cartes restituées<em></em><span class="text-danger">*</span></label>
                                <input id="nbre_de_carte_restitue" type="number"  class="form-control" name="nbre_de_carte_restitue" min="0" placeholder="Entrer nombre de photos enrolées manuellement" required autofocus>    
                                    @if ($errors->has('nbre_de_carte_restitue'))
                                    <span class="help-block">
                                        <strong>{{ $errors->first('nbre_de_carte_restitue') }}</strong>
                                    </span>
